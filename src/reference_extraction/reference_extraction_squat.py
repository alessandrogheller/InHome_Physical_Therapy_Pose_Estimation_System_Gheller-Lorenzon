"""Build a squat reference curve from MMFi knee-angle sequences."""
...
# Average one or more subjects to reduce dependence on individual technique.
...
def extract_knee_angle_sequence(subject):
    """Extract the valid left-knee angle sequence for one subject."""
    ...
    for frame_kp in keypoints_seq:
        # Skip frames with missing or invalid reference joints.
...
# Average the resampled sequences on the normalized timeline.
...
# Save the reference curve for real-time comparison.
