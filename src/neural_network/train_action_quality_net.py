...
The model uses normalized keypoint windows and is trained with the labels and
quality scores generated by the preceding dataset-building scripts.
"""
import os
import sys
import numpy as np
...
class WindowDataset(Dataset):
    def __init__(self, X, y_class, y_score):
        # Convert NumPy arrays to tensors and scale quality targets to [0, 1].
...
class ActionQualityNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # Use the shared representation for both exercise classification and
        # quality regression.
...
def run_epoch(model, loader, optimizer=None, class_weights=None):
    ...
    for X, y_class, y_score in loader:
        ...
        with torch.set_grad_enabled(is_training):
            ...
            # Combine the classification and quality-regression objectives.
...
def main():
    ...
    # Load the pre-built train/validation windows and their two targets.
    ...
    # Train for the configured number of epochs and monitor validation loss.
