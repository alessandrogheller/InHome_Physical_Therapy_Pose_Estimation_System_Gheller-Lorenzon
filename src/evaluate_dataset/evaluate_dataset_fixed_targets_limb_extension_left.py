...
from utils import (
    PROJECT_ROOT, DATASET_ROOT, LEFT_SHOULDER, LEFT_ELBOW, LEFT_WRIST,
...
def load_subject_angles(subject):
    ...
    for frame_kp in keypoints_seq:
        if keypoints_are_valid(frame_kp, None, [LEFT_SHOULDER, LEFT_ELBOW, LEFT_WRIST]):
            shoulder = frame_kp[LEFT_SHOULDER]
            elbow = frame_kp[LEFT_ELBOW]
            wrist = frame_kp[LEFT_WRIST]
...
print("\n--- Summary ---")
print(f"Action: {ACTION} (Limb extension, left arm)")
